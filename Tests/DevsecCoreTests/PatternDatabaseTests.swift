...
struct PatternDatabaseTests {
    ...
    func anthropicApiKey() {
        let text = "ANTHROPIC_API_KEY=sk-ant-api03-abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyzABCD-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXAA"
        let matches = PatternDatabase.findSecrets(in: text)
    ...
    func openAIKey() {
        let text = "OPENAI_KEY=sk-proj-abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMN"
        let matches = PatternDatabase.findSecrets(in: text)
    ...
    func githubServerToken() {
        let text = "GITHUB_TOKEN=ghs_abcdefghijklmnopqrstuvwxyzABCDEFGHIJ"
        let matches = PatternDatabase.findSecrets(in: text)
        #expect(matches.contains { $0.patternName == "GitHub Token" })
    }
    ...
    func stripeLiveKey() {
        // devsec-test-value: sk_test_ matches the same pattern as sk_live_
        let text = "STRIPE_SECRET=sk_test_abcdefghijklmnopqrstuvwxyz"
        let matches = PatternDatabase.findSecrets(in: text)
    ...
    func slackBotToken() {
        // devsec-test-value: two-segment form still matches xox[bprs]-[0-9A-Za-z\-]{20,}
        let text = "SLACK_TOKEN=xoxb-fake-devsectest0000000"
        let matches = PatternDatabase.findSecrets(in: text)
    ...
    func googleApiKey() {
        ...
        let text = "GOOGLE_API_KEY=AIzaSyAbcdefghijklmnopqrstuvwxyzABCDEFG"
        let matches = PatternDatabase.findSecrets(in: text)
    ...
    func sendgridKey() {
        ...
        let text = "SENDGRID_API_KEY=SG.abcdefghijklmnopqrstuvwx.abcdefghijklmnopqrstuvwxyz012345"
        let matches = PatternDatabase.findSecrets(in: text)
    ...
    func twilioToken() {
        let text = "TWILIO_AUTH_TOKEN=abcdef1234567890abcdef1234567890"
        let matches = PatternDatabase.findSecrets(in: text)
